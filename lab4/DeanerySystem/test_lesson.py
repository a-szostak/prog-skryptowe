...
class TestLesson(unittest.TestCase):
    ...
    def test_earlierDay(self):
        lesson1 = Lesson(Term(12, 50, day = Day.THU), "Programowanie skryptowe", "Stanisław Polak", 2)
        lesson2 = Lesson(Term(12, 50, day = Day.MON), "Programowanie skryptowe", "Stanisław Polak", 2)
    ...
    def test_laterDay(self):
        lesson1 = Lesson(Term(12, 50, day = Day.THU), "Programowanie skryptowe", "Stanisław Polak", 2)
        lesson2 = Lesson(Term(12, 50, day = Day.FRI), "Programowanie skryptowe", "Stanisław Polak", 2)

        self.assertEqual(lesson1.laterDay().day.value, 5)
        self.assertEqual(lesson2.laterDay(), False)

    def test_earlierTime(self):
        lesson1 = Lesson(Term(12, 15, day = Day.THU), "Programowanie skryptowe", "Stanisław Polak", 2)
        lesson2 = Lesson(Term(8, 20, day = Day.FRI), "Programowanie skryptowe", "Stanisław Polak", 2)
    ...
    def test_laterTime(self):
        lesson1 = Lesson(Term(12, 50, day = Day.THU), "Programowanie skryptowe", "Stanisław Polak", 2)
        lesson2 = Lesson(Term(19, 15, day = Day.FRI), "Programowanie skryptowe", "Stanisław Polak", 2)
